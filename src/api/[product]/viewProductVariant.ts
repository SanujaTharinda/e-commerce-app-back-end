...
/*
    STEP 1 - View Product Variants
*/

const viewProductVariant: Handler = async (req:Request, res: Response)=>{

    const {responseGenerator} = res;

    const result = await model.product.productVariant.viewProductVariant();
...
export default [viewProductVariant as EHandler];