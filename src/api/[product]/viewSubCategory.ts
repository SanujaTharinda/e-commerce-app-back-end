...
/*
    STEP 1 - View Sub Category
*/

const viewSubCategory: Handler = async (req:Request, res: Response)=>{

    const {responseGenerator} = res;

    const result = await model.product.subCategory.viewSubCategory();
...
export default [viewSubCategory as EHandler];